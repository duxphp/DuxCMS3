...
class WechatMiniappApi {
    ...
    public function index() {
        ...
        $config = target('wechat/WechatMiniapp', 'pay')->getConfig();
        try{
            ...
            if(!target($callbackInfo['target'], 'service')->pay($orderNo, price_calculate($data['total_fee'], '/', 100), '微信小程序', $data['transaction_id'], 'wechat_miniapp')) {
                $model->rollBack();
